      ...
      <div class="lr flex column">
        <div class="main-row">
          <div class="title" style="     justify-content: flex-start;">
            <span class="dzz">
              <font class="shuji">退休党委书记:</font>
              <font class="name">谢一</font>
              <font class="fushuji" style="margin-left:1vw;">副书记:</font>
              <font class="name">张二</font>
            </span>
            ...
            <vue3-seamless-scroll :list="array_s" class="scroll" :step="0.18" :hover="true" :class-option="classOption">
              <div class="item" v-for="item in array_s">
                <span class="dzz-item">
                  ...
                  <div class="name1">{{ item.shuji }}</div>
                  <div class="fushuji">委员:</div>
                  <div class="name2">{{ item.fushuju }} </div>
                  <div class="name2">{{ item.fushuju1 }}</div>
                </span>
              </div>
          ...
          <div class="title" style="justify-content:flex-start">
            ...
            <el-tooltip effect="customized" placement="left-start">
              <template #content>
                ...
                <p class="pop-content">五星：积极参加每次活动，并在活动中发挥积极、重要作用（如策划、组织、拍照、表演、写材料等）者。</p>
                <p class="pop-content">四星：积极参加每次活动者。</p>
                <p class="pop-content">三星：偶尔参加活动者。</p>
                <p class="pop-content">二星：身体健康但都没有参加活动者。</p>
                <p class="pop-content">一星：生活不能自理或者无法正常出行者。</p>
                <p class="pop-bottom">（此评定由退休党支部牵头组织实施，解释权在退休党支部）</p>
              </template>
              <div>银耀指数</div>
            </el-tooltip>
          </div>
            ...
            <el-tooltip effect="customized" placement="left-start">
              <template #content>
                <p style="font-size:16px;font-weight:bold;line-height: 3vh;">
                  活动动态：退休人员原所在单位、所在居住地、结对在职党支部等将平时走访、慰问、茶话会、“薪火结对”等活动的照片、视频、文字及时报退休党支部，录入“退休人员系统”的“活动动态”栏目。
                </p>
...
.screen-container {
  ...
  .screen-header {
    background-image: url(../../assets/screen/heander0927.png);
    background-size: 100% 100%;
    height: 80px;
    width: 100%;
